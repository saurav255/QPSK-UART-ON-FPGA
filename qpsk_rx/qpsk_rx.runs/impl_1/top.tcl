namespace eval ::optrace {
  variable script "C:/Vivado_Projects/qpsk_rx/qpsk_rx.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/Vivado_Projects/qpsk_rx/qpsk_rx.cache/wt [current_project]
  set_property parent.project_path C:/Vivado_Projects/qpsk_rx/qpsk_rx.xpr [current_project]
  set_property ip_output_repo C:/Vivado_Projects/qpsk_rx/qpsk_rx.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/Vivado_Projects/qpsk_rx/qpsk_rx.runs/synth_1/top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/Vivado_Projects/qpsk_rx/qpsk_rx.srcs/constrs_1/new/rx_constr.xdc
